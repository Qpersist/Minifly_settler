...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_rcdata = 0;
		ANO_DT_Send_RCData(g_t_Rc_D_CMS.THROTTLE,g_t_Rc_D_CMS.YAW,g_t_Rc_D_CMS.ROLL,g_t_Rc_D_CMS.PITCH,RX_CH[4],RX_CH[5],0,0,0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////	
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_power = 0;
		ANO_DT_Send_Power(voltage/10,0);
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid1)
	{
...
//#endif
	g_v_Uart1PutBuf(data_to_send, length);
}
