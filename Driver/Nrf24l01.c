...
volatile uint8_t g_u8a32_NRF24L01RXDataBuf_CMD[RX_PLOAD_WIDTH];//nrf24l01接收到的数据
volatile uint8_t g_u8a32_NRF24L01TXDataBuf_CMD[TX_PLOAD_WIDTH];//nrf24l01接收到的数据
