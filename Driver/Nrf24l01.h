...
#define _NRF24L01_H_
#include "stm32f10x.h"
#include "ANO_Drv_SPI.h"							//nrf24l01需要spi.h中的u8 Spi_RW(u8 dat)函数
//***************************************NRF24L01寄存器指令*******************************************************
...
extern uint8_t volatile g_u8a32_NRF24L01RXDataBuf_CMD[RX_PLOAD_WIDTH];//nrf24l01接收到的数据
extern uint8_t volatile g_u8a32_NRF24L01TXDataBuf_CMD[TX_PLOAD_WIDTH];//nrf24l01接收到的数据
extern 	uint8_t g_u8_NRF24L01RXDataBufLen_CMD;
